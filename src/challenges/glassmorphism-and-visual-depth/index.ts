...
import { challenge as glassRangeSlider } from './glass-range-slider/meta'

export const topic: Topic = {
  id: 'glassmorphism-and-visual-depth',
  title: 'Glassmorphism and Visual Depth',
  challenges: [glassCardComponent, glassHeaderNavbar, glassToggleSwitch, glassImageGallery, glassFlipCard, glassRangeSlider],
}
