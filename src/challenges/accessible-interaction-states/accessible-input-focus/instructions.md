...
1. When the input is focused (for example, using the **Tab** key), it should display a clear, visible box-shadow.
2. The box-shadow must be `0 0 0 3px rgba(38, 132, 255, 0.5)` (a soft blue glow).
