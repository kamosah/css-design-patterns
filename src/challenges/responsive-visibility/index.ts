...
import { challenge as adaptiveHeaderLogoNavVisibility } from './adaptive-header-logo-nav-visibility/meta'

export const topic: Topic = {
  id: 'responsive-visibility',
  title: 'Responsive Visibility',
  challenges: [mobileNavToggle, promotionalBannerVisibility, blogSidebarVisibility, mobileContactButtonVisibility, footerSocialIconsVisibility, responsiveArticleGridSidebarToggle, adaptiveHeaderLogoNavVisibility],
}
