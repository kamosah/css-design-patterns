...
import { challenge as responsiveBackgroundCover } from './responsive-background-cover/meta'
...
export const topic: Topic = {
  ...
  challenges: [fluidImageResizer, squareBoxFiller, responsiveVideoEmbed, fluidButtonWidth, responsiveBackgroundCover],
}
