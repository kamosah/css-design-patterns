...
export const topic: Topic = {
  ...
  challenges: [customRadioButton, customFileUpload, customToggleSwitch, customRangeSlider, customSelectDropdown, segmentedControlToggle, floatingLabelInput, customSearchInput, customColorPicker, threeStateCheckbox],
}
